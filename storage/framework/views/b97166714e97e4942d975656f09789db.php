    ...
    <nav>
        ...
        <div>
            <?php if(auth()->check()): ?>
                ...
                <a href="<?php echo e(route('patients.index')); ?>">Patients</a>
                <a href="<?php echo e(route('doctors.index')); ?>">Doctors</a>
...
<?php /**PATH C:\laragon\www\hospital management system\resources\views/layouts/app.blade.php ENDPATH**/ ?>